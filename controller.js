    ...
    handler: function (request, reply) {
        ...
        if (data.file) {
            ...
            data.file.on('end', function () {
                ...
                function () {
                    var cmd = 'curl -v -u admin:geoserver -XPUT -H "Content-type: application/octet-stream" --data-binary @' + path + ' http://127.0.0.1/geoserver/rest/workspaces/scale/datastores/products/' + name;
